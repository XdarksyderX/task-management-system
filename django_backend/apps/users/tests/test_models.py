"""
Simplified test suite for Users models

Tests that match the actual User and Team model structure.
"""
...
class CustomUserModelTest(TestCase):
    ...
    def test_unique_email_not_enforced(self):
        ...
        # Django's default User model doesn't enforce email uniqueness
...
class TeamModelMethodsTest(TestCase):
    ...
    def test_team_creation_timestamp(self):
        ...
        # Create another team and check timestamp is different
        import time
...
class ModelRelationshipsTest(TestCase):
    ...
    def test_cascade_behavior(self):
        ...
        # User should be removed from team when deleted
        user_id = self.user1.id
        self.user1.delete()
        
        # Team should still exist but user should be removed
