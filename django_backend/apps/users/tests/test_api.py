...
class UserModelValidationTest(TestCase):
    ...
    def test_username_validation(self):
        ...
        user = User.objects.create_user(
            username="valid_user123", email="valid@example.com", password="testpass123"
        )
    ...
    def test_email_validation(self):
        ...
        user = User.objects.create_user(
            username="testuser", email="valid.email@example.com", password="testpass123"
        )
    ...
    def test_password_setting(self):
        ...
        user = User.objects.create_user(
            username="testuser", email="test@example.com", password="plaintext_password"
        )
