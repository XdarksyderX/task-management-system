...
class AnalyticsEventService :
    ...
    def publish_dashboard_viewed (self ,user_id :int ,metadata :Dict [str ,Any ]=None )->bool :
    ...
    def publish_report_generated (self ,user_id :int ,report_type :str ,job_id :str ,
    ...
    def publish_report_downloaded (self ,user_id :int ,report_id :str ,
    metadata :Dict [str ,Any ]=None )->bool :
    ...
    def publish_analytics_query (self ,user_id :int ,endpoint :str ,query_type :str ,
    execution_time_ms :float ,metadata :Dict [str ,Any ]=None )->bool :
    ...
    def publish_user_stats_accessed (self ,requesting_user_id :int ,target_user_id :int ,
    metadata :Dict [str ,Any ]=None )->bool :
    ...
    def publish_team_performance_accessed (self ,user_id :int ,team_id :int ,
    metadata :Dict [str ,Any ]=None )->bool :
    ...
    def publish_task_distribution_viewed (self ,user_id :int ,metadata :Dict [str ,Any ]=None )->bool :
    ...
    def publish_error_occurred (self ,user_id :int =None ,error_type :str =None ,
    ...
    def _publish_event (self ,event :EventPayload ,key :str =None )->bool :
        ...
        try :
            ...
            if success :
                ...
                logger .warning (f"Failed to publish event: {event .event_type } for user: {event .user_id }")
            return success 
